  ...
  const careersData = {
    sobrecargo: {
      ...
      planEstudios: [
        ...
        "Reglamentación Aérea y Normativas",
        "Aerodinámica Teórica Básica",
        "Meteorología Aeronáutica General",
        "Seguridad y Procedimientos contra Emergencias",
        "Primeros Auxilios y Anatomía",
        "Factores Humanos y CRM (Crew Resource Management)",
        "Transporte Aéreo de Mercancías Peligrosas",
        "Disposiciones Generales del Servicio a Bordo",
        "Requerimientos Técnicos del Avión",
        "Inglés Técnico Aeronáutico Especializado"
      ],
      modalidades: [
        {
    ...
    oficial: {
      ...
      planEstudios: [
        "Introducción al Centro de Adiestramiento",
        "Gramática y Expresión Aeronáutica",
        "Principios de Administración General",
        "Síntesis Histórica de la Aviación",
        "Características de las Aeronaves y Sistemas",
        "Legislación Aeronáutica Nacional e Internacional",
        "Medicina de Aviación Preventiva",
        "Factores Humanos y Gestión (CRM)",
        "Aerodinámica Aplicada",
        "Reglamento de Control de Tránsito Aéreo",
        "Telecomunicaciones Aeronáuticas y Radio",
        "Inglés Técnico Aeronáutico para Despachadores",
        "Servicios Especiales de Información de Vuelo",
        "Meteorología Aeronáutica Avanzada I y II",
        "Operaciones de Vuelo y Peso y Balance I y II",
        "Navegación Aérea Estratégica Computarizada I y II",
        ...
        <motion.div {...cinematicFadeIn} className="max-w-5xl mx-auto px-6">
          <div className="h-[350px] w-full relative overflow-hidden bg-[#12151d]/40 rounded-[28px] border border-white/5 shadow-xl">
            ...
            <div className="absolute top-10 right-10 z-10 hidden md:block">
               <div className="bg-[#12151d]/90 backdrop-blur-xl p-8 rounded-[32px] border border-white/10 shadow-2xl max-w-sm text-white">
